...
export default class PowerBiService {
  ...
  static GetWorkspace = async (
    ...
    var restUrl =
      PowerBiApiRoot + "groups/" + "?$filter=id eq '" + WorkspaceId + "'";
    return fetch(restUrl, {
      headers: {
        Accept: "application/json;odata.metadata=minimal;",
        Authorization: "Bearer " + (await this.GetAccessToken()),
  ...
  static GetReport = async (
    ...
    if (WorkspaceId === MyWorkspace.id) {
      ...
      restUrl =
        PowerBiApiRoot + "groups/" + WorkspaceId + "/reports/" + ReportId;
    }
    return fetch(restUrl, {
      headers: {
        Accept: "application/json;odata.metadata=minimal;",
  ...
  static GetDataset = async (
    ...
    if (WorkspaceId === MyWorkspace.id) {
      ...
      restUrl =
        PowerBiApiRoot + "groups/" + WorkspaceId + "/datasets/" + DatasetId;
    }
    return fetch(restUrl, {
      headers: {
        Accept: "application/json;odata.metadata=minimal;",
  ...
  static ExportReport = async (
    ...
    let exportJob: PowerBiExportJob = await PowerBiService.StartExportReportJob(
      WorkspaceId,
      ReportId,
      ExportRequest
    );
    ...
    while (exportJob.status !== "Succeeded" && exportJob.status !== "Failed") {
      ...
      exportJob = await PowerBiService.GetExportReportJobStatus(
        WorkspaceId,
        ReportId,
        exportJob.id
      );
  ...
  static StartExportReportJob = async (
    WorkspaceId: string,
    ReportId: string,
    exportRequest: PowerBiExportRequest
  ...
  static GetExportReportJobStatus = async (
    WorkspaceId: string,
    ReportId: string,
    ExportId: string
  ): Promise<PowerBiExportJob> => {
